...
public class MyContextListener implements ServletContextListener,ServletRequestListener{
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		MyConnectionPool.init("swe3-2022team08","OesRQnYew8jAneTSKnUC","jdbc:mariadb://mysql-server:3306/swe3-2022team08_db");
		MyJedisPool.init("localhost",6379,"OesRQnYew8jAneTSKnUC");
